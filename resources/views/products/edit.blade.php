                ...
                <form method="post" action="{{ url('/admin/Products/update/'.$product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="title" value="{{ $product->title }}" required>
                                @error('title')
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="description" value="{{ $product->description }}" required>
                                @error('description')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="price" value="{{ $product->price }}" required>
                                @error('price')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="discountPercentage" value="{{ $product->discountPercentage }}" required>
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="rating" value="{{ $product->rating }}" required>
                                @error('rating')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="stock" value="{{ $product->stock }}" required>
                                @error('stock')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="file" class="form-control" id="example-text-input" name="thumbnail" value="{{ $product->thumbnail }}" required>
                                @error('thumbnail')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-md-9">
                                <input type="file" class="form-control" id="example-text-input" name="images[]" value="{{ $product->images }}" multiple required>
                                @error('images')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
