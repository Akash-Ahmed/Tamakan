                ...
                <table id="example" class="display table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    @foreach($token as $key=>$tokens)
                        <tr class="odd gradeX">
                            ...
                            <td class="d-none d-sm-table-cell"> {{ \Carbon\Carbon::parse($tokens->end_time)->format('Y-m-d H:i:s')}}</td>
                            <td class="d-none d-sm-table-cell"> {{ $tokens->extra_time }}</td>
                            <td class="d-none d-sm-table-cell"> {{ \Carbon\Carbon::parse($tokens->updated_at)->format('Y-m-d H:i:s')}}</td>
                            <td class="d-none d-sm-table-cell"> {{ \Carbon\Carbon::parse($tokens->created_at)->format('Y-m-d H:i:s')}}</td>
