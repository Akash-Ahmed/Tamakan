...
{{--                            <img class="card-img" style="height: 50px; width: 100%" src="{{ asset('admin_template/assets/media/photos/govt.png') }}" alt="">--}}
                        </a>
                    </div>
                    <!-- END Logo -->
                </div>
            ...
            <div class="content-header-section">
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
                        ...
                        <a class="dropdown-item" href="{{ url('/user_profile_update/'.Auth::user()->id) }}">
    ...
    <footer id="page-footer">
        <div class="content py-20 font-size-sm clearfix">
            <div class="float-right">
                Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="https://akash.iskool71.com" target="_blank">Md Ashiquzzaman</a>
            </div>
            <div class="float-left">
                <a class="font-w600" href="https://1.envato.market/95j" target="_blank">হবিগঞ্জ</a> &copy; <span class="js-year-copy"></span>
            </div>
        </div>
    </footer>
    <!-- END Footer -->
