                        ...
                        <div class="product-gallery product-gallery-vertical d-flex">
                            <div class="product-img-large">
                                <div class="img-large-slider common-slider" data-slick='{
                                    ...
                                    @php
                                        $p_image =json_decode($product->images);
                                    @endphp

                                    @foreach( $p_image as $key)
                                        <div class="img-large-wrapper">
                                            <a href="{{ $key }}" data-fancybox="gallery">
                                                <img src="{{ $key }}" alt="img">
                                            </a>
                                        </div>
                                        @endforeach
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-details ps-lg-4">
                            ...
                            <div class="product-rating d-flex align-items-center mb-3">
                                ...
                                <span class="rating-count ms-2">({{ $product->rating }})</span>
                            </div>
                            <div class="product-price-wrapper mb-4">
                                <span class="product-price regular-price">${{ $product->price }}</span>
                                <del class="product-price compare-price ms-2">Discount {{ $product->discountPercentage }}%</del>
                            </div>



                            <form method="post" action="{{ url('/admin/product/order/cart/'.$product->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="misc d-flex align-items-end justify-content-between mt-4">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <input type="number" name="total_number" value="1" min="0">
                                    </div>
