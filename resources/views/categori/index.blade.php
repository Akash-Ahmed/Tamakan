...
{{--                        <th class="d-none d-sm-table-cell"> Token Creation </th>--}}
                    ...
                    @foreach($category as $key=>$categorys)
                        <tr class="odd gradeX">
                            ...
                            <td class="font-w600"> {{ $categorys->name }} </td>
                            <td class="font-w600"> {{ $categorys->subcategories }} </td>

                            <td class="text-center">
                                <a href="{{ url('/admin/categories/delete/'.$categorys->id) }}" onclick="return confirm('Are you sure to delete')"
                                   class="btn btn-primary btn-xs">
                                    <i class="fa fa-trash-o "></i>
                                </a>
                                <a href="{{ url('/admin/categories/edit/'.$categorys->id) }}"
                                   class="btn btn-primary btn-xs">
