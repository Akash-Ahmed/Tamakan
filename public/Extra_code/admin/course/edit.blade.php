    ...
    <div class="col-md-12">
        <div class="block">
            ...
            <div class="block-content block-content-full">
                <form method="post" action="{{ url('/admin/product/update/'.$product->unique_id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="form-group row">
                            <label class="col-12" for="example-text-input">Product Name</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="example-text-input" name="name" value="{{ $product->name }}">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="example-text-input" name="quantity" value="{{ $product->quantity }}" required>
                                @error('quantity')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="example-text-input" name="price" value="{{ $product->price }}" required>
                                @error('price')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="example-text-input" name="d_price" value="{{ $product->d_price }}" required>
                                @error('d_price')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                                {{--                                <div class="form-text text-muted">Further info about this input</div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="example-select" name="status">
                                    ...
                                    @else
                                        <option value="{{ $product->status }}">Deactivate</option>
                        ...
                        <div>
                            <img src="{{ asset($product->image) }}" style="height:400px; width:800px;" >
                        </div>
                        <br>
                        <div>
                            {!! $product->description !!}
