                ...
                <ul class="nav-users push">
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('admin_template/assets/media/avatars/avatar2.jpg') }}" alt="">
                    ...
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('admin_template/assets/media/avatars/avatar13.jpg') }}" alt="">
                    ...
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('admin_template/assets/media/avatars/avatar6.jpg') }}" alt="">
                    ...
                    <li>
                        <a href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="{{ asset('admin_template/assets/media/avatars/avatar14.jpg') }}" alt="">
